  ...
  const educationData = [
    {
      ...
      institution: "MEH Arif High School",
      period: "2020 - 2022",
      icon: <FaSchool className="text-blue-400 text-3xl" />,
      achievements: [
        { icon: <FaAward className="text-yellow-400" />, text: "GPA: 4.83 (Science)" },
    ...
    },
    {
      ...
      achievements: [
        { icon: <FaAward className="text-yellow-400" />, text: "Current CGPA: 3.43 (C.S.T)" },
        { icon: <SiPython className="text-blue-500" />, text: "Python Programming" },
        { icon: <FaJava  className="text-red-500" />, text: "Java Programming" },
        { icon: <SiJavascript className="text-yellow-500" />, text: "Web Development" },
        { icon: <SiReact className="text-cyan-400" />, text: "Frontend Development" }
      ],
